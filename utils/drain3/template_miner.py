...
class TemplateMiner:
    ...
    def load_state(self, servicename):
        ...
        state = self.persistence_handler.load_state(servicename)
        if state is None:
        ...
        if self.config.snapshot_compress_state:
            ...
            state = zobj.decompress(base64.b64decode(state))
    ...
    def save_state(self, snapshot_reason):
        ...
        self.persistence_handler.save_state(state, snapshot_reason)
